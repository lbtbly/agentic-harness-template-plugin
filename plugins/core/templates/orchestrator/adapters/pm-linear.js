#!/usr/bin/env node
// pm-linear — CONTRACT STUB (ADR-0007: implemented on demand).
...
// Auth env NAMES (values live in the vault, never in the repo): LINEAR_API_KEY.
// Interactive mode may use the linear MCP server; headless MUST use REST-via-token
...
process.stderr.write('pm-linear: not implemented yet — contract stub (ADR-0007). ' +
