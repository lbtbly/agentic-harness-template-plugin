#!/usr/bin/env node
// pm-notion — CONTRACT STUB (ADR-0007: implemented on demand).
...
// Auth env NAMES (values live in the vault, never in the repo): NOTION_TOKEN.
// Interactive mode may use the notion MCP server; headless MUST use REST-via-token
...
process.stderr.write('pm-notion: not implemented yet — contract stub (ADR-0007). ' +
