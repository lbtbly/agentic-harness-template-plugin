...
Template: `.claude/skills/core:new-project/templates/runtime/mise.toml`. Not added unless chosen.
...
`.claude/skills/core:new-project/templates/devcontainer/`. Not added unless chosen.
