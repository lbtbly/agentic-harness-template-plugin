...
**Notion** likewise via relations, with the initiative as a real page in its own database
(ADR-0030), **Jira** uses Epics with parent-linked children, and the rest derive the tier
from the record.
